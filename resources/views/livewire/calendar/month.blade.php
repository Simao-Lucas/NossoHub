<div>
    ...
    <div class="w-full overflow-hidden rounded-3xl border border-white/8 bg-black/15">
        <div class="nh-calendar-grid border-b border-white/8">
